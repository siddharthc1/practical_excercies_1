...
# External table points to process Directory
# Archive Directory will store the backup for process fail
hadoop fs -mkdir /user/cloudera/workshop/process/ 						 
hadoop fs -mkdir /user/cloudera/workshop/archive/

# External table to load the csv files from the process Directory to hive database for task_2
